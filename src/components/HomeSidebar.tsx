            ...
            <div className="flex flex-col gap-6">
                {sections.map((section, index) => (
                    ...
                    >
                        {/* Vertical Line */}
                        <motion.div
                            className={`w-0.5 transition-all ${activeSection === section.id
                                    ? "h-12 bg-[#D84040]"
                                    : "h-8 bg-[#8E1616]"
                                }`}
                            animate={{
                                height: activeSection === section.id ? 48 : hoveredSection === section.id ? 40 : 32,
                                backgroundColor: activeSection === section.id ? "#D84040" : hoveredSection === section.id ? "#8E1616" : "#8E1616",
                            }}
                        />
                        ...
                        <motion.div
                            ...
                            className={`absolute right-6 whitespace-nowrap px-3 py-1.5 rounded-md ${activeSection === section.id
