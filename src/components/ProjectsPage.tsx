...
export function ProjectsPage() {
    ...
    const keyClients = [
        { name: "Malkapur", image: "/image_data/ProjectPage/malkapur.webp" },
        { name: "Akluj", image: "/image_data/ProjectPage/akluj.webp" },
        { name: "Washim", image: "/image_data/ProjectPage/washim.webp" },
        { name: "Parbhani", image: "/image_data/ProjectPage/parbhani.webp" },
        { name: "Chakan", image: "/image_data/ProjectPage/chakan.webp" },
        { name: "Jalgaon", image: "/image_data/ProjectPage/jalgaon.webp" },
        { name: "Wadgaon", image: "/image_data/ProjectPage/wadgaon.webp" },
        { name: "Dhule", image: "/image_data/ProjectPage/dhule.webp" },
        { name: "Sinnar", image: "/image_data/ProjectPage/sinnar.webp" },
        { name: "Chalisgaon", image: "/image_data/ProjectPage/chalisgaon.webp" },
        { name: "Baramati", image: "/image_data/ProjectPage/baramati.webp" },
        { name: "Daryapur", image: "/image_data/ProjectPage/daryapur.webp" },
        { name: "Amravati", image: "/image_data/ProjectPage/amc.webp" },
        { name: "Jalna", image: "/image_data/ProjectPage/jalna.webp" }
    ];
